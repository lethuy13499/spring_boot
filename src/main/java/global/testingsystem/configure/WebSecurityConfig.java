...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("**/users/**", "**/permission/**", "**/subject/**", "**/role/**", "**/chapter/**",
						"**/domain/**", "**/group/**", "**/exam/**", "**/question/**", "**/customer/**",
						"**/examResult/**", "**/examAnswer/**", "**/class/**", "**/unit/**", "**/downloadFileExcel/**")
				.authenticated().and().exceptionHandling().authenticationEntryPoint(restAuthenticationEntryPoint())
