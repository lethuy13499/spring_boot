...
public class JwtAuthenticationTokenFilter extends AbstractAuthenticationProcessingFilter {
        ...
        public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
                ...
                if (url.split("/")[1].contains("login")
                        ...
                        || url.split("/")[1].contains("product")
                        || url.split("/")[1].contains("class")
                        || url.split("/")[1].contains("examhome")
                        || url.split("/")[1].contains("exam")
                        || url.split("/")[1].contains("subject")
                        || url.split("/")[1].contains("getOneSubjectByIdExam")
                        || url.split("/")[len -1].contains("downloadFileExcel")
                        || url.split("/")[len -2].contains("dowload-file-exam-user")
                        || url.split("/")[len -1].contains("downloadFileTxt")) {
