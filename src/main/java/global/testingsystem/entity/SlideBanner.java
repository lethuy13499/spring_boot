...
public class SlideBanner {
	...
	@Column(name="link",nullable=false, length=60, columnDefinition = "NVARCHAR(60)")
	private String link;
...
//    }
    ...
    public SlideBanner(String img, String slogan, String title, String link, boolean show) {
		super();
		this.img = img;
		this.slogan = slogan;
		this.title = title;
