...
public interface UsersService {
	...
	List<Object> getlistExamOfUser(int userId);
	...
	// Linh
	List<Object> getPracticeCompletedByUser(int userId);

	List<Object> getExamResultsPractice(int userid, int subjectId);
	
	List<Object> getResultsPractice(int userid);
	
	List<Object> getPracticeOfUser(int userId);
}
