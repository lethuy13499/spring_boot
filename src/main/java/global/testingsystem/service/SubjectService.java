...
public interface SubjectService {
	...
	List<Subject> sortSubjectByName();
	...
	void updateSubjectByDomain(Subject subject);
	
	boolean checkNamSubjectDoNotExit(Integer id,String name);
	
	Integer getSubjectByExamId (int id);
}
