...
public interface QuestionService {
   ...
   int readTxt(String txtFilePath, String username);
   
   List<Object> getNumberQuestionOfDomain(int subjectId);
   List<Object> getNumberQuestionOfChapter(int subjectId);
   int countSearchQuestionBySubject(int subjectId,String keyword);
}
