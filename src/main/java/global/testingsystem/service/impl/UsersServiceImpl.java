...
public class UsersServiceImpl implements UsersService {
	...
	@Override
	public List<Object> getlistExamOfUser(int userId) {
		return usersRepository.getListExamOfUser(userId);
	}
	...
	// Linh
	@Override
	public List<Object> getPracticeCompletedByUser(int userId) {
		// TODO Auto-generated method stub
		return usersRepository.getPracticeCompletedByUser(userId);
	}

	@Override
	public List<Object> getExamResultsPractice(int userid, int subjectId) {
		// TODO Auto-generated method stub
		return usersRepository.getExamResultPractice(userid,subjectId);
	}

	// nmanh update 09-05
	public Boolean checkDate(Date birthday, Date date) {
		birthday = Utils.formatDateYYYYMMDD(birthday);
		// endDate = Utils.formatDateYYYYMMDD(endDate);
		date = Utils.formatDateYYYYMMDD(new Date());
	...
	@Override
	public List<Object> getResultsPractice(int userid) {
		// TODO Auto-generated method stub
		return usersRepository.getResultPractice(userid);
	}

	@Override
	public List<Object> getPracticeOfUser(int userId) {
		// TODO Auto-generated method stub
		return usersRepository.getPracticeOfUser(userId);
	}
