...
public class DomainController {
	...
	@GetMapping(value = ConstantPage.REST_API_GET_ALL_DOMAIN, produces = { MediaType.APPLICATION_PROBLEM_JSON_VALUE })
	public List<Object> getListDomain() {
		return domainService.getListDomain();
	}

	@PostMapping(value = "/domains")
	public List<Domain> fillAllDomain(@RequestBody FilterRegistration filter) {
		return domainService.fillAll(filter);
	}
	...
	@PostMapping(value = ConstantPage.REST_API_UPDATE_DOMAIN, produces = { MediaType.APPLICATION_PROBLEM_JSON_VALUE })
	...
	@PostMapping(value = ConstantPage.REST_API_INSERT_DOMAIN, produces = { MediaType.APPLICATION_PROBLEM_JSON_VALUE })
	...
	@GetMapping(value = ConstantPage.REST_API_SEARCH_DOMAIN, produces = { MediaType.APPLICATION_PROBLEM_JSON_VALUE })
	...
	@GetMapping(value = ConstantPage.REST_API_GETDOMAINBYSUBJECT, produces = {
			MediaType.APPLICATION_PROBLEM_JSON_VALUE })
    ...
    @GetMapping(value="/get-domain/subjectId/{id}")
	public List<DomainConvert> getAll(@PathVariable("id") Integer id) {
		return impl.findBySubjectId(id);
	}
}
